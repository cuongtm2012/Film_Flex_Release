/**
 * Easy Import Tool - A simplified script to import FilmFlex movies that works with CommonJS
 */
const { fetchMovieList, fetchMovieDetail, convertToMovieModel, convertToEpisodeModels } = require('../server/api');
...
async function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log('Usage:');
    console.log('  node easy_import.js [startPage] [endPage]');
    console.log('  node easy_import.js --resume');
    console.log('\nOptions:');
