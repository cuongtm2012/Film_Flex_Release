    ...
    <div className="flex h-screen">
      ...
      <div className="hidden lg:block w-1/2 bg-gradient-to-br from-gray-900 to-black text-white p-12 relative overflow-hidden">
        ...
        <div className="h-full flex flex-col justify-center relative z-10">
          ...
          <h2 className="text-3xl font-semibold mb-6 leading-tight">Your Ultimate <span className="text-primary">Movie Experience</span></h2>
              ...
              <div className="flex items-start mb-2">
                <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center mr-3 mt-1">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 8h-3v14h18v-14h-3v-2c0-2.209-1.791-4-4-4s-4 1.791-4 4v2zm0 0v-2c0-1.105.895-2 2-2s2 .895 2 2v2h-4z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold">Secure Access</h3>
                  <p className="text-sm text-gray-400">Role-based permissions for personalized experience</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/30 p-4 rounded-lg backdrop-blur-sm border border-white/10">
              <div className="flex items-start mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Continue watching where you left off</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/30 p-4 rounded-lg backdrop-blur-sm border border-white/10">
              <div className="flex items-start mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Premium quality on all your devices</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/30 p-4 rounded-lg backdrop-blur-sm border border-white/10">
              <div className="flex items-start mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Organize and save your favorites</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center text-sm text-gray-400">
            ...
            <div className="flex -space-x-2 ml-4">
              ...
              <div className="w-6 h-6 rounded-full bg-gray-700 border border-gray-800 flex items-center justify-center text-[10px]">+5k</div>
            </div>
          </div>
        </div>
      </div>
