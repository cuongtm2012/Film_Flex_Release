                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center p-3 border rounded-md">
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">Content moderation access</div>
                        </div>
                        <Button variant="outline" size="sm">Edit</Button>
                      </div>
                      <div className="flex justify-between items-center p-3 border rounded-md">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center p-3 border rounded-md">
                        <div>
                          <div className="font-medium">Content Reviewer</div>
                          <div className="text-sm text-muted-foreground">Review and approve content</div>
                        </div>
                        <Button variant="outline" size="sm">Configure</Button>
                      </div>
                      <div className="flex justify-between items-center p-3 border rounded-md">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <Button className="w-full">Apply to Selected</Button>
                      <Separator />
                      <div className="flex flex-col space-y-2">
