                    ...
                    <div className="space-y-4">
                      ...
                      {systemSettingsTab === "analytics" && (
                        <div className="space-y-4">
                          ...
                          <div className="border rounded-lg p-4 space-y-4 mt-6">
                            <h4 className="font-semibold flex items-center gap-2">
                              <span className="text-orange-600">Firebase</span> Push Notifications
                            </h4>

                            <div>
                              <Label htmlFor="firebase-project-id" className="block text-sm font-medium mb-2">
                                Firebase Project ID
                              </Label>
                              <Input
                                id="firebase-project-id"
                                placeholder="Enter Firebase Project ID"
                                value={systemSettings.firebaseProjectId || ''}
                            ...
                            <div>
                              <Label htmlFor="firebase-private-key" className="block text-sm font-medium mb-2">
                                Firebase Private Key
                              </Label>
                              <Textarea
                                id="firebase-private-key"
                                placeholder="-----BEGIN PRIVATE KEY-----&#10;...&#10;-----END PRIVATE KEY-----"
                                value={systemSettings.firebasePrivateKey || ''}
                                onChange={(e) => updateSetting('firebasePrivateKey', e.target.value)}
                                rows={4}
                            ...
                            <div>
                              <Label htmlFor="firebase-client-email" className="block text-sm font-medium mb-2">
                                Firebase Client Email
                              </Label>
                              <Input
                                id="firebase-client-email"
                                placeholder="firebase-adminsdk-xxxxx@your-project.iam.gserviceaccount.com"
                                value={systemSettings.firebaseClientEmail || ''}
                                onChange={(e) => updateSetting('firebaseClientEmail', e.target.value)}
                              />
                              <p className="text-xs text-muted-foreground mt-1">
                                From the same service account JSON file
                              </p>
                            </div>
                            ...
                            <div className="flex items-center justify-between bg-muted/20 p-3 rounded">
                              ...
                              <Switch
                                checked={systemSettings.firebaseNotificationsEnabled ?? false}
                                onCheckedChange={(checked) => updateSetting('firebaseNotificationsEnabled', checked)}
                              />
                            </div>
                          </div>
                        </div>
