...
export function securityHeaders(req: Request, res: Response, next: NextFunction): void {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://api.phimgg.com https://phimgg.com https://*.phimgg.com https://www.google-analytics.com https://cloudflareinsights.com https://fcm.googleapis.com https://firebase.googleapis.com https://firebaseinstallations.googleapis.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://*.kkphimplayer6.com https://*.phim1280.tv https://*.phimapi.com https://*.opstream12.com https://*.opstream17.com https://*.opstream90.com wss: ws:",
