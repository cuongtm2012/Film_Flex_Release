...
# This script will deploy the latest changes to 38.54.115.156
...
try {
    $recommendedTest = Invoke-RestMethod -Uri "http://${ServerIP}:5000/api/movies/recommended?page=1&limit=5" -Method Get -TimeoutSec 10
